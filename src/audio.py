...
class Audio:
    def __init__(self):
        ...
        self.stream = self.audio.open(format=AUDIO_FORMAT, rate=AUDIO_SAMPLE_RATE, channels=AUDIO_CHANNELS, input_device_index=AUDIO_DEVICE_INDEX, input=True, frames_per_buffer=AUDIO_CHUNK_SIZE)
